...
function RecipeCard({image,label, cuisineType}) {

    return (
        <>        
        <div className='card xl:h-128 lg:h-96 md:h-96 sm:h-96 h-72 bg-gradient-to-tr xl:p-0 lg:p-0 md:p-0 sm:p-0 p-2 bg-emerald-600 shadow-md  hover:scale-105 transition-all hover:z-30'>
